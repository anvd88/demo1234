...
import apiAuth from "@/apis/api_auth";
...
function Login() {
    ...
    const onSubmit = handleSubmit(async (data) => {
        try {
            const result = await apiAuth.signIn(data.email, data.password);
    ...
    //         navigate(ROUTES.HOME); // Điều hướng sau khi đăng nhập thành công
    //     } catch (error) {
    //         console.error("Error:", error);
    //     }
    // });
